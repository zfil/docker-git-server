...
generate_key_if_not_exist "${SSH_HOST_KEYS_DIR}/ssh_host_rsa_key" rsa
generate_key_if_not_exist "${SSH_HOST_KEYS_DIR}/ssh_host_ecdsa_key" ecdsa
generate_key_if_not_exist "${SSH_HOST_KEYS_DIR}/ssh_host_ed25519_key" ed25519
